...
using static LADXHD_Patcher_Lite.Functions;
...
namespace LADXHD_Patcher_Lite
{
    public partial class MainWindow : Window, IProgressWindow
    {
        ...
        public MainWindow()
        {
            ...
            this.Title = "LADXHD Patcher-Lite v" + Config.Version;
            Label_Title.Text = "Link's Awakening DX HD Patcher-Lite v" + Config.Version;
            Label_Description.Text = "Note that this version of the patcher requires online connectivity to patch the game. It patches v1.0.0 (or versions beyond " +
                "v1.1.4) to v" + Config.Version + " with the \"Patch\" button below. All patchers created since v1.1.4 back up the v1.0.0 files so that future " +
                "patches no longer require v1.0.0. When updating with this version of the patcher, future versions of the patcher can use the stored backup files.";
			mainWindow = this;
        }

        public static async Task UpdateTitleBarVersion()
        {
            mainWindow.Title = "LADXHD Patcher-Lite v" + Config.Version;
            mainWindow.Label_Title.Text = "Link's Awakening DX HD Patcher-Lite v" + Config.Version;
            mainWindow.Label_Description.Text = "Note that this version of the patcher requires online connectivity to patch the game. It patches v1.0.0 (or versions beyond " +
                "v1.1.4) to v" + Config.Version + " with the \"Patch\" button below. All patchers created since v1.1.4 back up the v1.0.0 files so that future " +
                "patches no longer require v1.0.0. When updating with this version of the patcher, future versions of the patcher can use the stored backup files.";
        }
        ...
        private void Button_ChangeLog_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                FileName = "https://gitlab.com/bighead.0/ladxhd_updated/-/blob/main/CHANGELOG.md",
