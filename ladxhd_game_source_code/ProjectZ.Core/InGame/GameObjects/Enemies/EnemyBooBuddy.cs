...
namespace ProjectZ.InGame.GameObjects.Enemies
{
    internal class EnemyBooBuddy : GameObject
    {
        ...
        public EnemyBooBuddy(Map.Map map, int posX, int posY, string lightKey) : base(map)
        {
            ...
            _aiDamageState = new AiDamageState(this, _body, _aiComponent, sprite, _lives, _dropIndex, true, false);
            var stunState = new AiStunnedState(_aiComponent, _animatorComponent, 3300, 900) { ShakeOffset = 1, SilentStateChange = false, ReturnState = "attacking" };
            ...
            AddComponent(HittableComponent.Index, _hitComponent = new HittableComponent(_body.BodyBox, OnHit) { StunThrown = true, MagicRodMultiplier = true });
        ...
        private void InitFleeing()
        {
            _animatorComponent.Sprite.Color = Color.White;
            _shadowDrawComponent.IsActive = true;
            _hitComponent.ArrowMultiplier = true;
            _animator.Play("flee");
        }
