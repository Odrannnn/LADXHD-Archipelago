...
namespace ProjectZ.InGame.GameObjects.Enemies
{
    internal class EnemyMadBomber : GameObject
    {
        ...
        public EnemyMadBomber(Map.Map map, int posX, int posY) : base(map)
        {
            ...
            _damageState = new AiDamageState(this, body, _aiComponent, _sprite, _lives, _dropIndex, false, false)
            {
                MoveBody = false,
                IsActive = false,
                SpawnPowerups = false,
            ...
            AddComponent(HittableComponent.Index, new HittableComponent(body.BodyBox, OnHit) { StunHookshot = true });
        ...
        {
            if (hitType == HitType.Bomb || _damageState.IsInDamageState())
