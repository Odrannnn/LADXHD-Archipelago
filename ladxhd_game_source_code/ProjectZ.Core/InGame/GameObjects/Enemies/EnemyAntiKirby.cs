    ...
    internal class EnemyAntiKirby : GameObject
    {
        ...
        private void UpdateSuck()
        {
            ...
            else if (playerDirection.Length() < 48 && playerDir == _direction)
            {
                ...
                MapManager.ObjLink.Body.Velocity.X = 0.5f * playerDirection.X;
                MapManager.ObjLink.Body.Velocity.Y = 0.5f * playerDirection.Y;
                MapManager.ObjLink.Body.DisableVelocityTargetMultiplier = true;
            }
        }
        ...
        private void EndTrap()
        {
            ...
            MapManager.ObjLink.Body.Velocity = new Vector3(_direction == 0 ? -1.5f : 1.5f, 0, 1.25f);
        ...
        private Values.HitCollision OnHit(GameObject gameObject, Vector2 direction, HitType hitType, int damage, bool pieceOfPower)
        {
            ...
            if (hitType == HitType.SwordShot || hitType == HitType.Bow || hitType == HitType.Hookshot || hitType == HitType.MagicPowder)
            {
            ...
            else if ((hitType & HitType.AnySword) != 0)
            {
