...
{
    internal class ObjSwordShotSpark : ObjAnimator
    {
        ...
        public ObjSwordShotSpark(Map.Map map, int posX, int posY, int offsetX, int offsetY)
            : base(map, posX, posY, offsetX, offsetY, Values.LayerTop, "Particles/swordShotDespawn", "run", deleteOnFinish: true)
        {
            // If a mod file exists load the values from it.
            string modFile = Path.Combine(Values.PathLAHDMods, "ObjSwordShotSpark.lahdmod");
