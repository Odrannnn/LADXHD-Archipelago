...
using ProjectZ.InGame.GameObjects.Identifiers;
...
namespace ProjectZ.InGame.GameObjects
{
    ...
    public class GameObjectTemplates
    {
            ...
            Func<string, Rectangle> sourceRectangle = null)
        {
            ...
            // Used in places where ObjMoveStone can block access.
            ObjectTemplates.Add("blockDoor_Seg1", new GameObjectTemplate(typeof(ObjCollider), new object[] { true, colliderColor, Values.CollisionTypes.Normal, new[] { new Rectangle(0, 8, 7, 8) } }));
            ObjectTemplates.Add("blockDoor_Seg2", new GameObjectTemplate(typeof(ObjCollider), new object[] { true, colliderColor, Values.CollisionTypes.Normal, new[] { new Rectangle(7, 9, 1, 7) } }));
            ObjectTemplates.Add("blockDoor_Seg3", new GameObjectTemplate(typeof(ObjCollider), new object[] { true, colliderColor, Values.CollisionTypes.Normal, new[] { new Rectangle(8, 10, 8, 6) } }));
            ...
            ObjectTemplates.Add("oneWayFlatTop-14", new GameObjectTemplate(typeof(ObjColliderOneWay), new object[] { new Rectangle(1, 0, 14, 1), Values.CollisionTypes.Normal, 3, true }));
            ...
            ObjectTemplates.Add("2d_round_left", new GameObjectTemplate(typeof(ObjCollider), new object[] { true, specColliderColor, Values.CollisionTypes.Normal, new[] { new Rectangle(4, 0, 12, 1), new Rectangle(3, 1, 13, 1), new Rectangle(2, 2, 14, 1), new Rectangle(1, 3, 15, 1), new Rectangle(0, 4, 16, 12) }}));
            ObjectTemplates.Add("2d_round_right", new GameObjectTemplate(typeof(ObjCollider), new object[] { true, specColliderColor, Values.CollisionTypes.Normal, new[] { new Rectangle(0, 0, 12, 1), new Rectangle(0, 1, 13, 1), new Rectangle(0, 2, 14, 1), new Rectangle(0, 3, 15, 1), new Rectangle(0, 4, 16, 12) }}));
            ObjectTemplates.Add("cSpecial",   new GameObjectTemplate(typeof(ObjCollider), new object[] { true, specColliderColor, Values.CollisionTypes.Normal, new[] { new Rectangle(0, 0, 16, 6) } }));
            ObjectTemplates.Add("lowCollider_special", new GameObjectTemplate(typeof(ObjCollider), new object[] { true, specColliderColor, lowerCollisionType, new[] { new Rectangle(0, 10, 16, 6) } }));
            ObjectTemplates.Add("anglerFishBarrier", new GameObjectTemplate(typeof(BossAnglerBarrier), new object[] { false } ));
            ...
            ObjectTemplates.Add("houseObject", new GameObjectTemplate(typeof(ObjHouse), new object[] { }));
            ...
            ObjectTemplates.Add("leaveButton", new GameObjectTemplate(typeof(ObjButtonLeave), new object[] { null, 0, 16, 16, false, false }));
            ...
            ObjectTemplates.Add("introStart", new GameObjectTemplate(typeof(ObjIntroStarter), new object[] { }));
            ...
            ObjectTemplates.Add("pushDialog", new GameObjectTemplate(typeof(ObjOnPushDialog), new object[] { null, 16, 16, 0 }));
            ...
            ObjectTemplates.Add("cameraFieldBoss", new GameObjectTemplate(typeof(ObjCameraFieldBoss), new object[] { null }));
            ObjectTemplates.Add("cameraFieldMStalfos", new GameObjectTemplate(typeof(ObjCameraFieldMStalfos), new object[] { null, 0 }));
            ...
            ObjectTemplates.Add("dungeonKeyhole", new GameObjectTemplate(typeof(ObjKeyhole), new object[] { null, null, null, 2250, 1.75f, 5.5f, 2800 }));
            ObjectTemplates.Add("enemytrigger", new GameObjectTemplate(typeof(ObjEnemyTrigger), new object[] { null, false }));
            ObjectTemplates.Add("enemydeathsync", new GameObjectTemplate(typeof(ObjEnemyDeathSync), new object[] { null, false, 50f }));
            ...
            ObjectTemplates.Add("dungeonBarriere", new GameObjectTemplate(typeof(ObjDungeonBarrier), new object[] { null, false, 0, false }));
            ObjectTemplates.Add("dungeonBarriereOrange", new GameObjectTemplate(typeof(ObjDungeonBarrier), new object[] { null, false, 1, false }));
            ObjectTemplates.Add("dungeonBarriereRed", new GameObjectTemplate(typeof(ObjDungeonBarrier), new object[] { null, false, 2, false }));
            ...
            ObjectTemplates.Add("personNew", new GameObjectTemplate(typeof(ObjPersonNew), new object[] { null, null, null, null, new Rectangle(0, 0, 14, 10), false, 32 }));
            ...
            ObjectTemplates.Add("owl", new GameObjectTemplate(typeof(ObjOwl), new object[] { null, new Rectangle(-16, 32, 48, 32), false, "owl", 0, false }));
            ...
            ObjectTemplates.Add("moblinSword", new GameObjectTemplate(typeof(EnemyMoblinSword), new object[] { false }));
            ...
            ObjectTemplates.Add("e9", new GameObjectTemplate(typeof(EnemyGreenZol), new object[] { 0, false, null }));
            ...
            ObjectTemplates.Add("stalfosGreen", new GameObjectTemplate(typeof(EnemyStalfosGreen), new object[] { null }));
            ...
            ObjectTemplates.Add("e18", new GameObjectTemplate(typeof(EnemyRiverZora), new object[] { false, 0, 0 }));
            ...
            ObjectTemplates.Add("e21", new GameObjectTemplate(typeof(EnemyGhini), new object[] { false, false, null }));
            ObjectTemplates.Add("e_giantGhini", new GameObjectTemplate(typeof(EnemyGhiniGiant), new object[] { false, null }));
