...
namespace ProjectZ.InGame.GameObjects.Bosses
{
    internal class BossAnglerFishStone : GameObject
    {
        ...
        public BossAnglerFishStone(Map.Map map, BossAnglerFish owner, int posX, int posY) : base(map)
        {
            ...
            AddComponent(DamageFieldComponent.Index, new DamageFieldComponent(damageBox, HitType.Enemy, 6) { OnDamagedPlayer = OnDamagedPlayer });
