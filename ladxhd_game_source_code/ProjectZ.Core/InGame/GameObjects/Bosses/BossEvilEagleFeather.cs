...
namespace ProjectZ.InGame.GameObjects.Enemies
{
    internal class BossEvilEagleFeather : GameObject
    {
        ...
        private BossEvilEagle _owner;
        private double _liveTime = 750;
        private bool _reflected;

        public BossEvilEagleFeather(Map.Map map, BossEvilEagle owner, Vector2 position, Vector2 velocity) : base(map)
        {
            ...
            AddComponent(DamageFieldComponent.Index, _damageFieldComponent = new DamageFieldComponent(damageBox, HitType.Enemy, 8) { OnDamagedPlayer = OnDamagedPlayer });
