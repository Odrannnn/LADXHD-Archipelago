...
namespace ProjectZ.InGame.GameObjects.MidBoss
{
    internal class MBossRollingBones : GameObject
    {
        ...
        public MBossRollingBones(Map.Map map, int posX, int posY, string triggerKey, string saveKey) : base(map)
        {
            ...
            AddComponent(HittableComponent.Index, _hitComponent = new HittableComponent(hittableBox, OnHit) { IsActive = false, ArrowMultiplier = true, BombMultiplier = true, BoomerangMultiplier = true, MagicRodMultiplier = true });
