...
namespace ProjectZ.InGame.GameObjects.MidBoss
{
    class MBossHinox : GameObject
    {
        ...
        private int hinox_1_red = 248;
        private int hinox_1_grn = 120;
        private int hinox_1_blu = 8;
        private int hinox_2_red = 248;
        private int hinox_2_grn = 8;
        private int hinox_2_blu = 40;
        private int hinox_3_red = 24;
        private int hinox_3_grn = 128;
        private int hinox_3_blu = 248;
        ...
        public MBossHinox(Map.Map map, int posX, int posY, string saveKey, int color) : base(map)
        {
            ...
            _sprite = new CSprite(EntityPosition) { SpriteShader = Resources.ColorShader, Color = _colors[color] };
            ...
            AddComponent(HittableComponent.Index, _hitComponent = new HittableComponent(hittableBox, OnHit) { IsActive = false, ArrowMultiplier = true, BombMultiplier = true, MagicRodMultiplier = true });
        ...
        private void Update()
        {
            ...
            else if (_initialized && !_playerInField)
            {
                ...
                {
                    var anim = new ObjAnimator(Map, (int)EntityPosition.X, (int)EntityPosition.Y - 16, Values.LayerTop, "Particles/pieceOfPowerExplosion", "run", true);
        ...
        private void ThrowBomb()
        {
            ...
            // spawn a bomb
            var bomb = new ObjBomb(Map, 0, 0, false, true, 1200, 2.75f);
        ...
        public Values.HitCollision OnHit(GameObject gameObject, Vector2 direction, HitType hitType, int damage, bool pieceOfPower)
        {
            ...
            if (!_aiDamageState.IsInDamageState() && _aiComponent.CurrentStateId != "deathBoss")
