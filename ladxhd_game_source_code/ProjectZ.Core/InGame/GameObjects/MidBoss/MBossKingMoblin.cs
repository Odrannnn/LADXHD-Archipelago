...
namespace ProjectZ.InGame.GameObjects.MidBoss
{
    class MBossKingMoblin : GameObject
    {
        ...
        private void ToAttack()
        {
            ...
            _damageField.SingleAxisPush = true;
            _damageField.PushMultiplier = 4.0f;
        ...
        private void ToBounce()
        {
            ...
            _damageField.SingleAxisPush = false;
            _damageField.PushMultiplier = 1.75f;
        ...
        private void OnDeath()
        {
            ...
            Game1.AudioManager.SetMusicFadeTransition(37, 0, 350);
        ...
        {
            if (_aiComponent.CurrentStateId == "damage" || _aiComponent.CurrentStateId == "pieceOfPower")
