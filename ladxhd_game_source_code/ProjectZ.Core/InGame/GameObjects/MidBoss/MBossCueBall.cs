...
namespace ProjectZ.InGame.GameObjects.MidBoss
{
    class MBossCueBall : GameObject
    {
        ...
        public MBossCueBall(Map.Map map, int posX, int posY, string saveKey, string enterKey) : base(map)
        {
            ...
            AddComponent(HittableComponent.Index, _hitComponent = new HittableComponent(_body.BodyBox, OnHit) { IsActive = false, ArrowMultiplier = true, BombMultiplier = true, BoomerangMultiplier = true, MagicRodMultiplier = true });
