...
{
    internal class ObjBall : GameObject, IHasSpriteVisibility
    {
        ...
        public ObjBall(Map.Map map, int posX, int posY, string saveKey) : base(map)
        {
            ...
            _sprite = new CSprite("ball", EntityPosition, new Vector2(-7, -15));
        ...
        private void UpdateIdle()
        {
            ...
            if (MapManager.ObjLink.IsTransitioning || (_body.IsGrounded && _body.Velocity == Vector3.Zero && _hasMoved))
            {
