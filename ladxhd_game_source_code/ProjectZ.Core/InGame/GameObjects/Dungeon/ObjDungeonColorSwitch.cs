...
namespace ProjectZ.InGame.GameObjects.Dungeon
{
    internal class ObjDungeonColorSwitch : GameObject
    {
        ...
        private int red_colorswitch_red = 255;
        private int red_colorswitch_grn = 8;
        private int red_colorswitch_blu = 42;
        private int yel_colorswitch_red = 254;
        private int yel_colorswitch_grn = 123;
        private int yel_colorswitch_blu = 8;
        private int blu_colorswitch_red = 25;
        private int blu_colorswitch_grn = 132;
        private int blu_colorswitch_blu = 255;
        ...
        public ObjDungeonColorSwitch(Map.Map map, int posX, int posY, string strKey, int stateCount, int stateIndex, int position, int neighbors) : base(map)
        {
            ...
            var hittableBox = new CBox(posX + 4, posY + 4, 0, 8, 8, 16);
