...
namespace ProjectZ.InGame.GameObjects.NPCs
{
    internal class ObjMonkey : GameObject
    {
        ...
        public override void Reset()
        {
            ...
            // Make sure the sprite is fully visible after a hard reset.
            _fadeDirection = 0;
        ...
        private void UpdateFade()
        {
            ...
            _fadeCounter = MathHelper.Clamp(_fadeCounter + _fadeDirection * Game1.DeltaTime, 0, FadeTime);

            _sprite.Color = Color.White * (_fadeCounter / FadeTime);

            if (_fadeCounter <= 0 || _fadeCounter >= FadeTime)
                _fadeDirection = 0;
        }
        ...
        private void StartBowWowFight()
        {
            ...
            // Achievement: BowWow and the monkey fight each other.
            AchievementManager.Earn(30);
        ...
        private void UpdateReset()
        {
            ...
            if (distance.Length() > 128 || MapManager.ObjLink.FieldChange)
            {
                ...
                // Respawn invisible, then fade the sprite back in.
                StartFadeIn();
            }
        }
