...
namespace ProjectZ.InGame.GameObjects.Things
{
    class ObjMovingPlatform : GameObject
    {
        ...
        private void UpdateMode1()
        {
            ...
            _isStandingOnTop = (_state == _time || (MapManager.ObjLink.Body.BodyBox.Box.Left >= _moveBox.Box.Left &&
                                                    MapManager.ObjLink.Body.BodyBox.Box.Right < _moveBox.Box.Right)) &&
                               MapManager.ObjLink.Body.IsGrounded &&
                               MapManager.ObjLink.Body.BodyBox.Box.Intersects(_moveBox.Box);
        ...
        {
            // is the player standing on the platform?
            var intersection = MapManager.ObjLink.Body.BodyBox.Box.Intersects(_moveBox.Box) &&
                               MapManager.ObjLink.Body.IsGrounded;
            _isStandingOnTop = MapManager.ObjLink.Body.BodyBox.Box.Left >= _moveBox.Box.Left &&
                               MapManager.ObjLink.Body.BodyBox.Box.Right < _moveBox.Box.Right && intersection;
