...
namespace ProjectZ.InGame.GameObjects.Things
{
    internal class ObjButtonLeave : GameObject
    {
        ...
        private readonly bool _oneUsage;

        private bool _isColliding;
        private bool _wasColliding;

        public ObjButtonLeave(Map.Map map, int posX, int posY, string strKey, int direction, int buttonWidth, int buttonHeight, bool negate, bool oneUsage) : base(map)
        {
        ...
        private void Activate()
        {
            ...
            // If it only has one usage then destroy it.
            if (_oneUsage)
