...
namespace ProjectZ.InGame.GameObjects.Things
{
    internal class ObjPullLever : GameObject
    {
        ...
        public ObjPullLever(Map.Map map, int posX, int posY, float retractingSpeed, string openStrKey) : base(map)
        {
            ...
            AddComponent(CarriableComponent.Index, new CarriableComponent(new CRectangle(_position, new Rectangle(-3, -4, 6, 2)), null, null, null) { IsStruggle = true, StartGrabbing = StartGrabbing, Pull = OnPull, IsCollision = true });
