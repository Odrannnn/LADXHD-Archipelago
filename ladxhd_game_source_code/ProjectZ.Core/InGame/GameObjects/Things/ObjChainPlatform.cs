...
namespace ProjectZ.InGame.GameObjects.Things
{
    class ObjChainPlatform : GameObject
    {
        ...
        private void Update()
        {
            ...
            var standingOnTop = MapManager.ObjLink.Body.BodyBox.Box.Intersects(_moveBox.Box) && MapManager.ObjLink.IsGrounded();
        ...
        private void MovePlatform(Vector2 offset)
        {
            ...
            SystemBody.MoveBody(MapManager.ObjLink.Body, offset * Game1.TimeMultiplier,
        ...
        private bool PlayerIsMovable()
        {
            ...
            SystemBody.MoveBody(MapManager.ObjLink.Body, new Vector2(0, 1), Values.CollisionTypes.Normal, false, false, false);
