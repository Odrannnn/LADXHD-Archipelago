...
namespace ProjectZ.InGame.GameObjects.Things
{
    internal class ObjIslandBackground : GameObject
    {
        ...
        private int sky_color_red   = 65;
        private int sky_color_grn   = 90;
        private int sky_color_blu   = 255;
        private int ocean_color_red = 66;
        private int ocean_color_grn = 89;
        private int ocean_color_blu = 255;
