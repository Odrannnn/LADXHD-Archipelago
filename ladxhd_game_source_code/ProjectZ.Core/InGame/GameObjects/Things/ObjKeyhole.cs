...
namespace ProjectZ.InGame.GameObjects.Things
{
    internal class ObjKeyhole : GameObject
    {
        ...
        private readonly float _shakeMax;
        private readonly float _shakeSpeed;
        ...
        public ObjKeyhole(Map.Map map, int posX, int posY, string itemName, string outputKey, string strDialog, int shakeTime, float shakeMax, float shakeSpeed, int openTime) : base(map)
        {
            _itemName = itemName;
        ...
        private void Update()
        {
            ...
            if (!_rumbling && _counter > 500)
            {
                ...
                if (GameSettings.ScreenShake)
                    Game1.GameManager.ShakeScreen(_shakeTime, _shakeMax, 0.00f, _shakeSpeed, 0.00f);
            }
