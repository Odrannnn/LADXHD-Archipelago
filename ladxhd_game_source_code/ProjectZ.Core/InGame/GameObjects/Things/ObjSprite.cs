...
namespace ProjectZ.InGame.GameObjects.Things
{
    public class ObjSprite : GameObject
    {
            ...
            Rectangle collisionRectangle, Values.CollisionTypes collisionType) : this(map, posX, posY, spriteId, positionOffset, layer, shadowSpriteId)
        {
            ...
            AddComponent(CarriableComponent.Index, new CarriableComponent(new CRectangle(EntityPosition, new Rectangle(collisionRectangle.X + 1, collisionRectangle.Y + 1, collisionRectangle.Width - 2, collisionRectangle.Height - 2)), null, null, null) { IsCollision = true });
        }
