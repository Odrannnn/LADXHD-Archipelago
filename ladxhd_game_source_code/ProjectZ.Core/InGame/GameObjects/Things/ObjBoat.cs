...
namespace ProjectZ.InGame.GameObjects.Things
{
    class ObjBoat : GameObject
    {
        ...
        public ObjBoat(Map.Map map, int posX, int posY) : base(map)
        {
            ...
            _objFisherman = new ObjFishermanBoat(map, this, posX + 1, posY - 16, null, "npc_fisherman", "npc_bridge", new Rectangle(0, 1, 14, 20));
        ...
        private void OnKeyChange()
        {
            ...
            if (!string.IsNullOrEmpty(spawnNecklace) && spawnNecklace == "1")
            {
                ...
                _necklace = new ObjItem(Map, (int)spawnPosition.X, (int)spawnPosition.Y, null, "fisher_trade", "trade11", null);
        ...
        private void Update()
        {
            ...
            {
                _necklace = new ObjItem(Map, 96, 40, null, "fisher_trade", "trade11", null);
                Map.Objects.SpawnObject(_necklace);
            }
        }
