...
namespace ProjectZ.InGame.Things
{
    public class Resources
    {
        ...
        public static Effect ColorCorrect;
        ...
        {
            PixelGrid = LoadOptional<Effect>(content, "Shader/PixelGrid");
            ColorCorrect = LoadOptional<Effect>(content, "Shader/GBCColorCorrection");
        }

        public static T LoadOptional<T>(ContentManager content, string assetName, T fallback = null)
            where T : class
        {
            try
            {
        ...
        public static void LoadTextures(GraphicsDevice graphics, ContentManager content)
        {
            ...
            // Load achievement icons (achievement0.png, achievement1.png, ...).
            LoadTexturesFromFolder(Path.Combine(Values.PathDataFolder, "Achievements"));
            ...
            smallFont_redux = LoadOptional(content, "Fonts/smallFont_redux", smallFont);
            smallFont_vwf = LoadOptional(content, "Fonts/smallFont_vwf", smallFont);
            smallFont_vwf_redux = LoadOptional(content, "Fonts/smallFont_vwf_redux", smallFont);
            ...
            SprMamuLight = LoadOptional(content, "Light/mamuLight", SprLight);
            ...
            sgbBorder = LoadOptional<Texture2D>(content, "Menu/sgb_border");
        ...
        public static void LoadTexturesFromFolder(string path, bool recurse = false)
        {
                ...
                skipDirectory: dir => string.Equals(dir, "Intro", StringComparison.OrdinalIgnoreCase)))
            {
                ...
                try
                {
                    ...
                    // Mods deliberately overwrite base textures, so release the one being replaced.
                    if (TextureList.TryGetValue(textureName, out var oldTexture) && oldTexture != texture)
                        oldTexture.Dispose();
