    ...
    public static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                {
                    // Stop SDL text input before Run to prevent the Steam Deck keyboard from opening unexpectedly.
                    var textInputService = new DesktopGLTextInputService();
                    ...
                    game.Services.AddService(typeof(ITextInputService), textInputService);
                    game.Services.AddService(typeof(IPlatformWindow), new DesktopGlPlatformWindow());
