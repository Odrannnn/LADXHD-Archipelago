...
namespace ProjectZ.Editor
{
    internal class AnimationScreen : InGame.Screens.Screen
    {
        ...
        public void SaveAnimationDialog()
        {
            ...
            if (result.IsOk)
                EditorAssetSaver.SaveAnimator(result.Path, _animator);
        }

        public void SaveAnimation()
        {
            EditorAssetSaver.SaveAnimator(_lastFileName, _animator);
        }
        ...
        public void UpdateAnimations()
        {
            ...
            foreach (var fileName in result.Paths)
            {
                ...
                EditorAssetSaver.SaveAnimator(fileName, _animator);
            }
        }
