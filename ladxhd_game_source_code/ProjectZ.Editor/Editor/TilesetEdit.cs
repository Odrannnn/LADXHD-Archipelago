...
namespace ProjectZ.Editor
{
    internal class TilesetEdit : InGame.Screens.Screen
    {
        ...
        {
            foreach (var tile in _tileSetData)
                tile.SprTile?.Dispose();
        ...
        {
            using var renderTarget = new RenderTarget2D(Game1.Graphics.GraphicsDevice, _outputWidth * _tileSize, _outputHeight * _tileSize);
